...
carpetaFotos("FresasRecortadasM", listdir("./FresasRecortadasM"), "0 1 0")
carpetaFotos("FresasRecortadasP",  listdir("./FresasRecortadasP"), "1 0 0")
carpetaFotos("FresasRecortadasA", listdir("./FresasRecortadasA"), "0 0 1" )
